...
class AIA_Transformer_merge(nn.Module):
    ...
    def forward(self, input1, input2):
        ...
        for i in range(len(self.row_trans)):
            ...
            if i >=1:
                output_ri_i = input_ri + output_list_mag[-1]
            else: output_ri_i = input_ri
            input_ri_mag = output_ri_i + output_list_mag[-1]
            AFA_input_ri = input_ri_mag.permute(3, 0, 2, 1).contiguous().view(dim1, b*dim2, -1)  # [F, B*T, c]
            ...
            ATA_input_ri = input_ri_mag.permute(2, 0, 3, 1).contiguous().view(dim2, b*dim1, -1)  # [T, B*F, C]
