...
from aia_trans import dual_aia_trans_merge_crm, aia_complex_trans_mag, aia_complex_trans_ri, dual_aia_trans_merge_crm_atfa
import soundfile as sf

os.environ['CUDA_VISIBLE_DEVICES'] = '5'

def enhance_mag(args):
    model = aia_complex_trans_mag()
    ...
    with torch.no_grad():
        ...
        for _, snr_key in enumerate(snr):
            ...
            for file_id in file_list:
                ...
                frame_num = int(np.ceil((wav_len - 320 + 160) / 160 + 1))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--mix_file_path', type=str, default='/home/yuguochen/wsj_testset/CTSNet/mix/factory1/unseen/')
    parser.add_argument('--esti_file_path', type=str, default='./estimated_audio/wsj30h/aia_inter_wsj30_best/factory1/unseen/')
    parser.add_argument('--snr', type=list, default=[-3, 0, 3])     #  -5  -2  0  2  5
    parser.add_argument('--fs', type=int, default=16000,
                        help='The sampling rate of speech')
    parser.add_argument('--Model_path', type=str, default='./BEST_MODEL/aia_inter_wsj30.pth.tar',
    ...
    parser = argparse.ArgumentParser('Recovering audio')
    parser.add_argument('--mix_file_path', type=str, default='/home/yuguochen/wsj_testset/CTSNet/mix/factory1/seen/')
    parser.add_argument('--esti_file_path', type=str, default='./estimated_audio/wsj30h/aia_inter_wsj30_best/factory1/seen/')
    parser.add_argument('--snr', type=list, default=[-3, 0, 3])     #  -5  -2  0  2  5
    parser.add_argument('--fs', type=int, default=16000,
                        help='The sampling rate of speech')
    parser.add_argument('--Model_path', type=str, default='./BEST_MODEL/aia_inter_wsj30.pth.tar',
    ...
    parser = argparse.ArgumentParser('Recovering audio')
    parser.add_argument('--mix_file_path', type=str, default='/home/yuguochen/wsj_testset/CTSNet/mix/babble/seen/')
    parser.add_argument('--esti_file_path', type=str, default='./estimated_audio/wsj30h/aia_inter_wsj30_best/babble/seen/')
    parser.add_argument('--snr', type=list, default=[-3, 0, 3])     #  -5  -2  0  2  5
    parser.add_argument('--fs', type=int, default=16000,
                        help='The sampling rate of speech')
    parser.add_argument('--Model_path', type=str, default='./BEST_MODEL/aia_inter_wsj30.pth.tar',
